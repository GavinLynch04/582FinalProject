...
class Five82Press(DuoAttentionPress):
    ...
    # Smaller defaults than DuoAttentionPress (128/256) so compression takes effect
    # on the short system prompts typical in IFEval (60-120 tokens).
    short_context_sink_size: int = 4
    short_context_recent_size: int = 16
    ...
    def __post_init_from_model__(self, model):
        ...
        # Override the large on-the-fly defaults (sink=128, recent=256) with values
